export default function Home() {
  return (
    <section className="flex flex-col items-center justify-center min-h-screen text-center px-6 text-[#F2F2F5]">
      <div className="max-w-4xl">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 mb-14">
          ...
          <button className="border border-[#F2F2F5] text-[#F2F2F5] font-semibold py-3 px-6 rounded-2xl hover:bg-[#F2F2F5] hover:text-black transition-all duration-200">
            Découvrir l'app
          </button>
        </div>
